...
class TestGetAllSkillsDirs:
    def test_local_always_first(self, hermes_home, external_skills_dir):
        ...
        with patch.dict(
            os.environ,
            {
                ...
                "HERMES_SKILLS_DIR": str(hermes_home / "skills"),
            },
        ):
    ...
    def test_canonical_root_included_for_profile_home(self, hermes_home, tmp_path):
        ...
        with patch.dict(
            ...
            {
                "HERMES_HOME": str(hermes_home),
                "HERMES_SKILLS_DIR": str(canonical),
            },
        ):
            from agent.skill_utils import get_all_skills_dirs
            result = get_all_skills_dirs()
